...
// @public (undocumented)
export function checkRootSymbol(sym: any): boolean;

// @public (undocumented)
export function checkSymbol(sym: any): boolean;
...
// @public (undocumented)
export const michaelo: {
    num: number;
};

// @public (undocumented)
export const misoSymbol: unique symbol;
...
export class SharedTree extends SharedTreeCore<FieldChangeMap, DefaultChangeFamily> implements ISharedTree {
    ...
    // (undocumented)
    getMisoSymbol(): symbol;
    // (undocumented)
    getProxyTargetSymbol(): symbol;
    // (undocumented)
    getRootFieldKeySymbol(): GlobalFieldKeySymbol;
    // (undocumented)
