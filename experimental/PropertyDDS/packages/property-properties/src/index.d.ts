	...
	namespace PROPERTY_TREE_NS {
		...
		class ContainerProperty extends BaseProperty {
			...
			resolvePath<T = BaseProperty>(
				in_path: string,
				in_options?: ContainerProperty_resolvePath_in_options_TYPE,
			): T | undefined;
			/**
		...
		interface IPropertyFactory {
			...
			create<T extends BaseProperty>(
				in_typeid: string,
				in_context?: string,
				in_initialProperties?: any,
				in_options?: PropertyFactory_create_in_options_TYPE,
			): T;
			/**
			...
			inheritsFrom(
				...
				in_options?: PropertyFactory_inheritsFrom_in_options_TYPE,
			): boolean;
			/**
		...
		class Workspace extends EventEmitter {
			...
			revertTo(
				in_commitUrn: string,
				in_options?: Workspace_revertTo_in_options_TYPE,
			): Promise<void>;
			/**
			 ...
			 */
			setRebaseCallback(
				in_callback?: Function | undefined,
				in_options?: Workspace_setRebaseCallback_in_options_TYPE,
			): void;
			/**
			...
			checkout(
				...
				in_options?: Workspace_checkout_in_options_TYPE,
			): Promise<any>;
			/**
			...
			resolvePath<T = BaseProperty>(
				in_path: string,
				in_options?: Workspace_resolvePath_in_options_TYPE,
			): T | undefined;
			/**
		...
		class BaseProperty {
			...
			protected _resolvePathSegment(
				in_segment: string,
				in_segmentType: TOKEN_TYPES_TYPE,
		...
		class NamedProperty extends ContainerProperty {
			 ...
			 */
			share(
				permissions: NamedProperty_share_permission_TYPE,
				options?: NamedProperty_share_options_TYPE,
			): Promise<any>;
			/**
			 * Unshare property with given subject(s)
			 */
			unshare(
				permissions: NamedProperty_unshare_permission_TYPE,
				options?: NamedProperty_unshare_options_TYPE,
			): Promise<any>;
			/**
		...
		class ReferenceProperty extends ValueProperty {
			...
			resolvePath<T = BaseProperty>(
				in_path: string,
				in_options?: ReferenceProperty_resolvePath_in_options_TYPE,
			): T | undefined;
			/**
		...
		class RepositoryReferenceProperty extends ContainerProperty {
			 ...
			 */
			disableWrite(): void;
			getReferencedWorkspace(): Workspace;
			/**
